...
- [adk-js](https://github.com/google/adk-js) - Fixed Cloud SQL Unix-socket connections for MySQL and MariaDB — connection strings like `/cloudsql/PROJECT:REGION:INSTANCE` and `?host=` overrides were failing to parse, so they now work like the earlier Postgres fix, merged to `main` [PR #871](https://github.com/google/adk-js/pull/871) and released in [v2.1.0](https://github.com/google/adk-js/releases/tag/main-v2.1.0) ([3b59a2c](https://github.com/google/adk-js/commit/3b59a2c0b361e229ee3b8c26e93588fb512773db))
