...
- **[Prisma ORM](https://github.com/prisma/prisma)** — Contributed a **fix** for the Microsoft SQL Server adapter via [PR #29630](https://github.com/prisma/prisma/pull/29630), officially included in the [**Prisma ORM 7.9.0**](https://github.com/prisma/prisma/releases/tag/7.9.0) release notes.
